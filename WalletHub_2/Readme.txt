...
2. Set the classpath environment variables for the Jars folder included in the project ex.classpath = "D:\Projects\Selenium-Projects\WalletHub_2\*;
...
6. Open TestReport folder to see latest html report